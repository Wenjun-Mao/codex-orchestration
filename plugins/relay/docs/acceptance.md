...
| KI-05 | Frozen result/event/bytes, no resend after ambiguity, queue/receipt/acceptance distinct | Authentic final capture and exact recipient receipt required for closure |
| KI-06 | Exact task archive intent/observation, no Git deletion or old-HEAD checks | Affirmative native archival with retained source |
...
not repeated. Verify foreign-hook harmlessness and old pending reporting across
