...
function validateTask(value, index) {
  ...
  requireExactFields(value, {
    required: ["id", "title", "mode", "dependencies", "write_paths", "shared_resources", "serial_gate"],
  }, label);
...
export function validatePlan(value, { projectMaxConcurrency = 32 } = {}) {
  requireExactFields(value, {
    required: ["schema_version", "plan_id", "baseline_revision", "max_concurrency", "tasks"],
  }, "Plan");
  if (value.schema_version !== 1) throw new CliError("Unsupported plan schema_version");
