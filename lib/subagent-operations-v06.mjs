...
import { REASONING_EFFORTS, validateSelectorRationale } from "./model-routing-v06.mjs";
...
export async function prepareSubagentOperation({
  ...
  const { transitionWorkflowOperationClaim } = await import("./workflow-journal-v06.mjs");
  await transitionWorkflowOperationClaim({ stateRoot, subagentOperation: prepared });
  return prepared;
}
