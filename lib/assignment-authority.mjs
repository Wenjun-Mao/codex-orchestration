...
export async function assertAssignmentRouteAuthority({ stateRoot, route, allowRegistering = false }) {
  const assignment = await assignmentAuthority({ stateRoot, assignmentId: route.assignment.assignment_id });
  const permitted = allowRegistering ? ["registering", "open", "accepted"] : ["open", "accepted"];
