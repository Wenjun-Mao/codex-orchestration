...
function validateRecord(value) {
  ...
  if (value.schema_version !== 4 || value.kind !== "terminal-callback-record") {
    throw new CliError("Unsupported terminal callback record; v0.4 does not migrate older callback journals");
  }
  ...
  if (source !== null && source !== "journal-monitor") {
    throw new CliError("v0.4 supports journal-monitor observation only");
  }
