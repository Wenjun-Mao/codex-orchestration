...
export async function observePrivateUnplugV07({ plan, codexHome, now = Date.now() }) {
  ...
  return {
    schema_version: 1,
    kind: "codex-flow-v07-unplug-private-observation",
    plan_id: checked.plan_id,
    plan_digest: unplugPlanDigestV07(checked),
    repository: {
