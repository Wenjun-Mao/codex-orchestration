...
export async function assertTerminalReceiptAuthority({ stateRoot, receipt }) {
  ...
  const expectedModelEvidence = {
    configured: modelSelector(launch.task_contract.task),
    requested: modelSelector(launch.selector_evidence.requested),
    accepted: launch.selector_evidence.accepted === null
      ? null
      : modelSelector(launch.selector_evidence.accepted),
    observed: observedModelSelector(launch.selector_evidence.observed),
  };
