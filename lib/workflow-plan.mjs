...
function acceptedDispositionAuthority(value, label) {
  ...
  const record = {
    ...
    revision_id: requireText(value.revision_id, `${label}.revision_id`, { max: 128, safeId: true }),
    task_id: requireText(value.task_id, `${label}.task_id`, { max: 128, safeId: true }),
    task_contract_digest: requireDigest(value.task_contract_digest, `${label}.task_contract_digest`),
  ...
  return {
    ...
    revision_digest: record.revision_id,
