...
function authority(commonDir = "/tmp/codex-flow-authority/.git") {
  ...
  return {
    run_id: "run-workflow-v09",
    runtime_context_digest: RUNTIME_DIGEST,
    configuration_digest: CONFIGURATION_DIGEST,
    repository_id: "repository-workflow-v09",
...
function acceptedDisposition(plan) {
  ...
  return {
    ...
    launch_id: "task-launch-research",
...
test("v0.9 workflow and generated-contract schemas have one closed root authority each", async () => {
