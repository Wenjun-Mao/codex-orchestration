...
| Same-host final capture, staged reporter upgrade survival, harmless unregistered stops, and exact runtime retirement | `report-hook-v093.test.mjs`, `report-lifecycle-v093.test.mjs` |
