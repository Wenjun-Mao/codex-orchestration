...
| Same-host final capture, shared-director recipient preservation across fresh sender fences, staged reporter upgrade survival, runtime-bundle staging, harmless unregistered stops, resumable route registration, atomic accept/cancel terminal selection, and exact runtime retirement | `cli-v09.test.mjs`, `assignment-lifecycle-v097.test.mjs`, `coordinator-recipient-routing-v097.test.mjs`, `report-hook-v093.test.mjs`, `report-lifecycle-v093.test.mjs` |
