...
The accepted public release remains v0.8.2. This checkout is the unreleased
v0.8.3-dev.0 development authority.
...
- the exact-version `.git/codex-flow/v0.8.3-dev.0/` operational state root;
