...
The exact v0.7.8 adapter is the only predecessor adapter in v0.8.0. It reads and
validates raw legacy records only through modules from the authenticated
v0.7.8 runtime bundle; target v0.8 validators are not legacy authority.
